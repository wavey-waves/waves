          ...
          <div className="flex-shrink-0 p-4 pb-15 border-t border-white/10 bg-black/40 backdrop-blur-xl">
            ...
            >
              <input
                ...
                className="flex-1 bg-white/5 text-white rounded-xl px-3 py-1.5 sm:px-4 sm:py-2 text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-emerald-600/50 border border-white/10"
              />
              <button
                type="submit"
                className="px-4 sm:px-6 py-1.5 sm:py-2 bg-gradient-to-r from-emerald-600 to-cyan-600 rounded-xl text-white hover:opacity-90 transition-opacity font-medium text-sm sm:text-base whitespace-nowrap flex items-center gap-1.5"
              >
                <svg 
                  xmlns="http://www.w3.org/2000/svg" 
                  className="h-4 w-4 sm:h-5 sm:w-5" 
